...
- `Web/JS/SingleHtml.js` regenerates those outputs. Use `node Web\JS\SingleHtml.js --check` or `scripts/verify-help-docs.ps1` to check whether they are current without rewriting files.
