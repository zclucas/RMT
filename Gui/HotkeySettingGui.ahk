...
class HotkeySettingGui {
    ...
    static HotkeyDefs := [
        ...
        {Field: "DebugRunHotkey", Label: "继续", OnlyTrigger: true, Default: "f5"},
        {Field: "DebugStepHotkey", Label: "步入", OnlyTrigger: true, Default: "f11"}
    ]
    ...
    _BuildAndShow() {
        ...
        this.ui.xaml := StrReplace(this.ui.xaml, 'Width="940" Height="700"', 'Title="' title '" ShowInTaskbar="True" Width="630" Height="330" Opacity="0"')
